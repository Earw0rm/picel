...
int test1(){
    ...
    val1 = dqueue_alloc(int);
    dqueue_free(val1);
    ASSERT(val1 == nullptr, "free(pub api) should delete the pointer correctly");
...
int test3(){
    ...
    ASSERT(stride2 == 8, "stride after push should not change");
    ASSERT(lenght2 == 1, "lenght after push should be += 1");
